/*
 * This is based on David Chambers Hashify editor
 */
...
(function (window) {
                    ...
                    switch (re.exec(text)[1].length) {
                        case 0:
                            ...
                            switch (re.exec(_(this.before) + '✪' + _(this.after))[1].length) {
                                ...
                                case 2:
                                    return this.before.substr(0, position -= 3) + text + this.after.substr(2);
                            }
                        case 1:
                            len -= 2;
                            position += 1;
    ...
    Hashify = window.Hashify = {
        ...
        editor:function (id, preview, callback_) {
            ...
            createButton = bind(createButton_, toolbar, bind(callback_ || function () {
            }, el));
